            ...
            <div className="flex flex-col justify-between w-full md:w-1/3 mt-16 md:mt-0 md:pl-20 lg:border-l border-[#0d1833]/10 h-full py-8 md:py-28">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <a href="mailto:enquiry@fakhruddinproperties.com" className="block text-sm font-sans tracking-widest text-[#0d1833]/80 hover:text-[#b69c6b] transition-colors break-all">
