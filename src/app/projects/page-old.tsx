      ...
      <div className={`flex flex-col lg:flex-row ${align === 'right' ? 'lg:flex-row-reverse' : ''}`}>
        ...
        <div ref={imageRef} className="lg:w-1/2 h-[400px] lg:h-[600px] relative overflow-hidden">
          ...
          <div className="absolute bottom-6 left-6 right-6 flex justify-between text-white">
            ...
            <div className="text-2xl font-serif text-[#A19585]">{specs.price || "Contact Us"}</div>
          </div>
        </div>
          ...
          <div className="w-full space-y-6">
            ...
            <div className="space-y-2">
              <span className="text-[#A19585] text-xs tracking-[0.3em]">
                {String(index + 1).padStart(2, '0')} — {title.split(' ')[0]}
              </span>
            ...
            {/* Additional Features */}
            <div className="flex items-center gap-6 text-xs text-black/40 pt-4">
              <div className="flex items-center gap-2">
                <div className="w-1 h-1 rounded-full bg-[#A19585]" />
...
function PhilosophySection() {
  ...
  const philosophies = [
    {
      title: "Designing for What's Next",
      description: "As cities evolve, our developments anticipate what tomorrow's residents truly need: wellness, sustainability, and intelligent infrastructure."
    },
    {
      title: "Architecture With a Pulse",
      description: "No two projects are ever alike — because no two communities are. Our residences reflect architectural personality and emotional resonance."
    },
    {
      title: "Recognised. Respected. Rewarded.",
      description: "Recognised with 20+ industry awards, Fakhruddin Properties is known for advancing sustainability, innovation, and wellness-led development."
    }
  ];

  return (
    <section ref={ref} className="relative w-full py-20 lg:py-28 bg-[#F9F8F6]">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="text-[#A19585] text-xs sm:text-sm tracking-[0.3em]">THE FOUNDATION</span>
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-black mt-4">
            Every project is shaped by balance
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {philosophies.map((item, i) => (
            ...
            >
              <div className="text-[#A19585] font-serif text-4xl mb-4">0{i + 1}</div>
